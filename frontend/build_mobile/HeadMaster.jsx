...
const HeadMaster = () => {
  ...
  const renderPaginationControls = ({
    ...
    return (
      <div className={`flex items-center justify-center gap-3 px-0 sm:px-2 py-6 border-t border-gray-200 ${className}`}>
        <button
  ...
  return (
      ...
      <main className="flex-1 w-full lg:ml-64 flex flex-col pb-20 lg:pb-0 min-h-screen">
          ...
          <div className="flex-1 w-full max-w-7xl mx-auto p-2 sm:p-6 lg:p-12 z-10">
             <div className="relative bg-white/30 backdrop-blur-xl rounded-3xl shadow-xl p-2 sm:p-6 border border-white/20 min-h-[70vh]">

...
const TherapistDashboard = () => {
  ...
  const load‹ PreviousGoals = async (studentId, type) => {
    try {
  ...
  return (
      ...
      <main className="flex-1 w-full lg:ml-64 flex flex-col pb-[calc(80px+env(safe-area-inset-bottom)+16px)] lg:pb-8 min-h-[100dvh]">
          ...
          <div className="lg:hidden w-full p-4 text-center bg-white shadow-sm z-40 sticky top-0">
              <h1 className="text-xl font-bold text-[#170F49] font-baskervville">Hi {userName}</h1>
          </div>

          <div className="flex-1 w-full max-w-7xl mx-auto p-2 sm:p-6 lg:p-12 z-10">
             <div className="relative bg-white/30 backdrop-blur-xl rounded-3xl shadow-xl p-2 sm:p-6 border border-white/20 h-auto min-h-[50dvh] mb-6">
                  ...
                  <div className="flex items-center gap-4 text-[#170F49]">
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        ...
                        setUnlockedGoals({});
                        load‹ PreviousGoals(student.id, initialType);
                      }}
                    >
                      Enter Report
                    </button>
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setUnlockedGoals({});
                    load‹ PreviousGoals(selectedStudent.id, newType);
                  }}
                >
